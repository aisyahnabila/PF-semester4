                    ...
                    <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><button class="dropdown-item active bg-purple" type="button"><small>Latest
                                                (5.3.x)
                                                <i class="bi-check"></i></small></button></li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="dropdown" data-bs-theme="light">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><button class="dropdown-item active bg-purple" type="button">
                                            <small><i class="bi-brightness-high-fill me-2"></i>Light</small></button>
                                    </li>
                                    <li><button class="dropdown-item" type="button">
                                            <small><i class="bi-moon-stars-fill me-2"></i>Dark</small></button></li>
                                    <li><button class="dropdown-item" type="button">
                                            <small><i class="bi-circle-half me-2"></i>Auto</small></button></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <p class="fs-5">Take Bootstrap to the next level with premium themes from the
                        ...
                        their
                        own extended frameworks, rich with new components and plugins, documentation, and powerful build
                        tools.
                    </p>
                    <a class="icon-link icon-link-hover lead fw-semibold mb-5" href="#">
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    ...
                    <div class="mt-2 text-muted">
                        <small>Designed and built with all the love in world by the
                            <a href="#" class="text-black">Bootstrap Team</a>
...
<?php /**PATH C:\Users\aisya\Documents\praktikumnabil\resources\views/cloning.blade.php ENDPATH**/ ?>